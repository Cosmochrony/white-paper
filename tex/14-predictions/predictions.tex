...
\section{Testable Predictions and Observational Signatures}
  ...
  qualitative and semi-quantitative signatures whose robustness or intermittence reflects
  the distinct topological or spectral nature of the underlying projected invariants,
  thereby distinguishing Cosmochrony from standard cosmological and quantum approaches.
  ...
  \input{14-predictions/01-hubble-constant-from-chi-dynamics}
  \input{14-predictions/02-redshift-drift}
  \input{14-predictions/03-gravitational-wave-propagation}
  \input{14-predictions/04-galaxy-rotation-chi}
  \input{14-predictions/05-spin-and-topological-signatures}
  \input{14-predictions/06-absence-of-dark-energy-signatures}
  \input{14-predictions/07-cmb-polarization-signatures}
  \input{14-predictions/08-neutrino-decay-signatures}
  \input{14-predictions/09-environmental-modulation-lifetimes}
  \input{14-predictions/10-strong-gravitational-lensing-without-dark-matter}
  \input{14-predictions/11-experimental-outlook-and-discriminating-signatures}
  \input{14-predictions/12-summary}
