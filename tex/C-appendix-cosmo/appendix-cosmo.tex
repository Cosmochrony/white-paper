...
\section{Cosmological and Observational Implications of Cosmochrony}
  ...
  \input{C-appendix-cosmo/C06-spectral-gravitational-toy-model}
  \input{C-appendix-cosmo/C07-substrate-origin-phi-eff}
  \input{C-appendix-cosmo/C08-spectral-saturation-galaxies}
  \input{C-appendix-cosmo/C10-neutrino-mediated-structural-smoothing-and-cosmological-inference}
  \input{C-appendix-cosmo/C11-observational-tests-voids}
