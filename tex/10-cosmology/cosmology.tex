\section{Cosmological Implications}
  ...
  \subsection{The Big Bang as a Maximal Constraint Regime of the $\chi$ Field}
    ...
    \cite{Einstein1915,Weinberg1972}.
    ...
    of these constraints, through which effective spacetime notions gradually emerge~\cite{Penrose1989Weyl}.
    ...
    from the monotonic evolution of $\chi$ away from its maximally constrained state~\cite{Prigogine1997,Rovelli1991}.
  ...
  \subsection{Cosmic Expansion Without Inflation}
    ...
    homogeneity, isotropy, and spatial flatness~\cite{Guth1981,Linde1982}.
  ...
  \subsection{Emergent Hubble Law}
    ...
    naturally to a Hubble-like law~\cite{Hubble1929,Hogg1999}.
  ...
  \subsection{Cosmic Microwave Background}
    ...
    the transition to a stable geometric regime~\cite{SachsWolfe1967,HuWhite1997}.

    No superluminal expansion within spacetime is required to account for observed
    large-angle correlations~\cite{Planck2020}.
  ...
  \subsection{The Hubble Tension}
    ...
    Within Cosmochrony, this discrepancy finds a natural qualitative explanation.
  ...
  \subsection{Large-Angle Temperature Anomalies}
    ...
    have been reported in multiple analyses of Planck data~\cite{Planck2020}.

    In Cosmochrony, such features may reflect residual correlations inherited from
    the pre-geometric phase of the $\chi$ field.
