...
\subsection{Large-Angle Temperature Anomalies}
  ...
  \begin{figure}[htbp]
    ...
    {3-gravitation-and-cosmology/07-cosmology/cmb_lowell_lcdm_cosmo}
  ...
  A complementary unsmoothed representation, directly confronting the raw
  Planck low-$\ell$ data with the same attenuation mechanism, is provided in
  Appendix~\ref{app:lowell_attenuation} (Fig.~\ref{fig:cmb_lowell_unsmoothed}).
