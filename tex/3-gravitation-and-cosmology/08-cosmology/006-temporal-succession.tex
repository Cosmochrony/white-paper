...
%
% LABELS ASSUMED (align with existing document):
%   \label{sec:minkowski-emergence}     -- Minkowski section
%   \label{sec:spectral-entropy}        -- S_Pi[g] definition
%   \label{eq:relational-energy}        -- E_chi = ||L phi||^2
%
...
\subsection{The Self-Referential Origin of Temporal Succession}
  ...
  \paragraph{Co-emergence of space and time from a single operator.}
    ...
    (see~\cite{Beau2026aa} and Section~\ref{sec:spectral-admissibility}),
    ...
    As established in Section~\ref{sec:minkowski-emergence} and in~\cite{Beau2026c},
  ...
  \paragraph{Metric rigidity and the general-relativistic space--time budget.}
    ...
    (Section~\ref{sec:spectral-entropy} and~\cite{Beau2026h}).
    ...
    of flux conservation under the constrained effective operator~(Section~\ref{sec:gravity-schwarzschild}
    and~\cite{Beau2026c, Beau2026h}).
  ...
  \paragraph{Summary.}
    ...
    programme~\cite{Beau2026aa}, with the Lorentz and Einstein structures
