\subsection{Effective Potential for Galactic Dynamics from Projective Capacity Saturation}
  ...
  \paragraph{Emergent acceleration scale.}
    The nonlinear projective saturation constraint induces an effective
  ...
  \paragraph{Asymptotic regimes and flat rotation curves.}
    ...
    In the high-acceleration regime ($g_N \gg a_0$), $g_{\mathrm{eff}} \simeq g_N$.
  ...
  \paragraph{Baryonic Tully--Fisher scaling.}
    ...
    \begin{table}[t]
      ...
      \begin{tabular}{p{2.8cm} p{3.8cm} p{3.8cm} p{3.8cm}}
        ...
        & Non-baryonic halo
        & Modified dynamics
        & Projective saturation properties of~$\chi$ \\
        \hline
...
\subsubsection*{Observed rotation curves: multi-galaxy test}
  ...
  \begin{figure}[t]
    ...
    {3-gravitation-and-cosmology/08-cosmology/galaxy_rotcurves_3panel}
