\subsection{Dark Matter as Residual Projective Effects}
  \label{subsec:dark-matter-phenomenology}

  Dark matter phenomena correspond to configurations of~$\chi$ that resist
  projective ordering advancement while failing the projectability conditions
  ...
  \paragraph{Galactic Rotation and Effective Spectral Stiffness.}
    ...
    $G_{\mathrm{eff}}$ induced by the local projective ordering state.
  ...
  \paragraph{Gravitational Lensing and Substrate Memory.}
    ...
    \textbf{projective lag}: the projective geometry associated with
