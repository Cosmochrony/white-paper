\subsection{Emergent Hubble Law}
  ...
  In homogeneous regimes, the projective ordering is uniform and admits the
  ...
  \paragraph{Cosmic Acceleration Without Dark Energy.}
    ...
    constrain the local projective ordering rate, introducing growing spatial
    inhomogeneities.
    ...
    progressively uneven projective ordering across cosmic scales.
