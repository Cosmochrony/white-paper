\subsection{Recovery of the Schwarzschild Metric}
  ...
  \paragraph{Operational potential from projective ordering slowdown.}
  ...
  \paragraph{Metric components from \texorpdfstring{$\Phi$}{Φ}.}
    ...
    \node[right] at (2.8,0.2)
      ...
      constraint on the admissible projective ordering rate, manifesting as
      differential proper-time accumulation and emergent metric curvature.}
