\subsection{Black Hole Evaporation and the Information Problem}
  ...
  \subsubsection*{Emergent Temperature and Projective Ordering Gradient}
    \label{subsec:emergent-temperature}

    The apparent Hawking temperature is determined by the gradient of
    the effective projective ordering rate normal to the horizon:
    \[
  ...
  \subsubsection*{Prediction: Spectral Granularity}
    ...
    \end{equation}
    where $\tau_\chi$ is the characteristic projective ordering timescale
    near the horizon $\alpha \simeq 3 \times 10^{-7}$ is the spectral packing fraction,
    and $Q$ is the topological charge of the emitted configuration.
