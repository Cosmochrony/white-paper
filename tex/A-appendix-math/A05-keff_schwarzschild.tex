\subsection{Strong-Field Constitutive Coupling Near a Schwarzschild Black Hole}
  ...
  \paragraph{Purpose and status.}
    Section~\ref{subsec:microscopic-origin-of-the-coupling-tensor-and-the-poisson-equation} introduced an effective constitutive
    ...
    Schwarzschild phenomenology at leading order (Section~\ref{subsec:recovery-of-the-schwarzschild-metric}).
    ...
    the approach to an effective horizon (Section~\ref{subsec:strong-gravity-and-black-holes}).
  ...
  \paragraph{Operational time-dilation factor.}
    ...
    potential $\Phi$ (Section~\ref{subsec:microscopic-origin-of-the-coupling-tensor-and-the-poisson-equation}).

  \paragraph{Matching to Schwarzschild form.}
    Section~\ref{subsec:recovery-of-the-schwarzschild-metric} argues that, in regimes where a stable
