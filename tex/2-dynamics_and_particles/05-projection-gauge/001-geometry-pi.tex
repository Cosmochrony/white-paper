\subsection{The Geometry of the \texorpdfstring{$\Pi$}{Π} Subspace}
  ...
  $SU(2)\times U(1)$ symmetry structure, which emerges as an invariance of the projection process.
  ...
  used as a numerical and representational support, not as a physical discretization.
  The mapping from the global graph Laplacian~$\Delta_G$ to the effective projected Laplacian~$\Delta_\Pi$ is
  \begin{equation}
