\subsection{Necessity of Non-Injective Projection for Emergent Gravity and Mass}
  ...
  \subsubsection*{Operational definitions and standing assumptions}
    ...
    relaxation rule $F$ (the $\chi$-dynamics of
  ...
  \subsubsection*{Theorem: Necessity of non-injective projection and bounded relaxation flux}
  ...
  \item \label{thm:b}
  The substrate relaxation flux must be bounded, providing the selection principle required for a unique infrared
  dynamics
  with controlled higher-order corrections.
    ...
    \begin{proof}
      ...
      with~\ref{D1}--\ref{D4}.
      The bounded relaxation flux $|\partial_t \chi| \leq c_\chi$
