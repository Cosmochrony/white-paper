\subsection{Antiparticles, Creation/Destruction, and CPT}
  ...
  \subsubsection*{Antiparticles as Relationally Conjugate Configurations}
    ...
    This constitutes a process of \emph{structural unknotting}: mass measures
    the degree of topological obstruction to projective ordering advancement.

    \paragraph{Why Antimatter Does Not Require Time Reversal.}
      \label{subsec:why-antimatter-no-time-reversal}
      The monotone growth of projected spectral structure defines an absolute
      arrow of admissible projection that cannot be inverted.
