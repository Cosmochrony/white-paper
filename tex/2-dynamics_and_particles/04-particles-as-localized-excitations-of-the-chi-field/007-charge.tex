\subsection{Charge as a Topological and Projective Property of \texorpdfstring{$\chi$}{χ}}
  \label{subsec:charge-as-a-topological-and-relaxational-property-of-chi}

  \subsubsection*{Unified Projective Budget for Mass and Charge}
    \label{subsec:unified_budget_mass_charge}

    Both inertial mass and electric charge draw on the same finite projective
    capacity of~$\chi$.
    ...
    \begin{equation}
      ...
      \le \mathcal{B}_{\max},
    \end{equation}
    where $\mathcal{B}_{\max}$ is fixed by the universal projective capacity
  ...
  \subsubsection*{Charge as a Directed and Conjugate Projective Mode}
    ...
    At the discrete level, the $\chi$ structure induces a bounded admissible
    ...
    The formal identification of electric charge as a $\pi_1$ winding invariant
    of the $U(1)$ Hopf fiber, and the proof of charge quantisation from
    $\pi_1(S^1) \cong \mathbb{Z}$, are given in
    Section~\ref{sec:charge-quantisation-pi1} and~\cite{Beau2026k}.
    ...
    \paragraph{CP Symmetry as Projective Chirality.}
      ...
      the level of~$\chi$.
      The formal definition of projective chirality and its structural
      mechanisms are given in Section~\ref{sec:projective-chirality}
      and~\cite{Beau2026k}.
