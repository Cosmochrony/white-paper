\subsection{Variational Formulation and Born--Infeld Action}
  ...
  projective ordering constraints may be summarized in a compact variational
  form.
  ...
  and $\rho$ the effective density of projectively stable configurations.
...
representation}.
  ...
  \paragraph*{Connection to Emergent Geometry.}
    ...
    summarizing the effective geometric regularities of projected configurations.
  ...
  \paragraph*{Why This Is Not a Scalar--Tensor Theory.}
    ...
    Gravitation emerges from the local constraint on the projective ordering
    rate, not from the exchange of a scalar mediator.
...
\subsubsection*{Operational saturation scale and acceleration proxy}
  ...
  projective flux transport in the substrate~$\chi$.
  The kinematic bound $c$ appearing in the square-root structure is the
  effective projection of this invariant limit in weak-field geometric
  regimes.
