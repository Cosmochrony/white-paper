% ----------------------------------------------------------------------------
% Section 11.8 --- Neutrino-Mediated Relaxation, Decay Signatures,
%                  and Environmental Modulation
% Merges former §14.8 and §14.9, heavily condensed
% ----------------------------------------------------------------------------
...
reorganization
(Sections~\ref{subsec:metastability-and-decay},
\ref{subsec:neutrinos-partially-projectable-modes}).
