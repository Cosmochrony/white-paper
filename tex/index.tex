...
\newcommand{\version}{v1.1, January 2026}
\date{\version}
...
\begin{document}
  ...
  \section{Mathematical Formulation of the $\chi$ Field Dynamics}
    \label{sec:mathematical-formulation-of-the-chi-field-dynamics}
    \input{A-maths/A-index}
  ...
  \section{Phenomenological Implications}
    ...
    \input{C-phenomenological-implications}
