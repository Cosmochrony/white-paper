\subsection{Monotonicity and Arrow of Time}
  ...
  \paragraph{Projectability and Kinematic Saturation.}
    ...
    capacity, rather than as a fundamental geometric deformation of spacetime itself
        \footnote{This kinematic saturation concerns the ordering and coherence capacity of the
    projection itself and should not be conflated with thermodynamic entropy production,
      which is addressed separately in later sections.}.
