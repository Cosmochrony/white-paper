\subsection{Relational Projection and Spectral Admissibility}
  \label{sec:relational-projection}
  ...
  \paragraph{Non-injectivity of the admissibility projection.}
    ...
    This loss of distinguishability is not a defect of the formalism, but a direct
    ...
    This non-injectivity is a structural property of the Cosmochrony framework.
    Introduced constructively in Section~\ref{subsec:geometric-action} and formalized
    here at the spectral level, it reflects a genuine identification of relational
    configurations imposed by the admissibility criteria themselves.
    Together with the bounded character of substratic relaxation and the compensatory
    role of effective observables, it constrains the class of admissible projected
    regimes.
    These structural principles are stated explicitly in the following subsection and
    will be assumed throughout the remainder of this work.
    Subsequent sections do not re-justify non-injectivity, but investigate its physical
    consequences for quantum correlations, internal degrees of freedom, and
