...
\section{Definition and Fundamental Properties of the \texorpdfstring{$\chi$}{χ} Substrate}
  ...
  \input{03-chi-field/04-relational-projection}
  \input{03-chi-field/05-structural-principles-and-projective-regimes}
  \input{03-chi-field/06-monotonicity-and-arrow-of-time}
  \input{03-chi-field/07-local-relaxation-speed}
  \input{03-chi-field/08-relation-to-conventional-fields}
  \input{03-chi-field/09-initial-conditions-and-global-structure}
