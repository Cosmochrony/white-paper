...
% Annotation
  ...
  \paragraph{Ontological Status of the $\chi$ Substrate.}

    The $\chi$ substrate is not a field in the conventional sense, as it does not possess
    local values and does not propagate on a pre-existing spacetime manifold.
    Instead, it encodes a \textbf{relational structure} whose admissible configurations
    give rise, through projection, to effective spacetime descriptions and physical
    observables.
