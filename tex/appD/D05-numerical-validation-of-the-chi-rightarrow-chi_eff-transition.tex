...
coarse-grained dynamics}.
    ...
    \begin{figure}[t]
      \centering
      \includegraphics[width=0.78\linewidth]{appD/D04_epsilon_vs_time_compare}
    ...
    \begin{figure}[t]
      \centering
      \includegraphics[width=0.78\linewidth]{appD/D04_saturation_fraction_compare}
    ...
    \begin{figure}[t]
      \centering
      \includegraphics[width=0.72\linewidth]{appD/D04_residual_hist_smooth}
  ...
  \paragraph{Spatial structure of the effective field and residual.}
    ...
    \begin{figure}[t]
      \centering
      \includegraphics[width=0.47\linewidth]{appD/D04_chi_eff_slice_smooth}
      \hfill
      \includegraphics[width=0.47\linewidth]{appD/D04_residual_slice_smooth}
