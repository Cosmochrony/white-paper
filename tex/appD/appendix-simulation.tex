...
\input{appD/D01-collective_coupling}
\input{appD/D02-chi-parameters}
\input{appD/D03-consistency_checks}
\input{appD/D04-simulation-algorithms-for-chi-field-dynamics}
\input{appD/D05-numerical-validation-of-the-chi-rightarrow-chi_eff-transition}
\input{appD/D06-renormalization-hbar}
\input{appD/D07-spectral_ratio_derivation}
\input{appD/D08-rotation-curve-fits}
