...
% Arrows
  ...
  \begin{figure}[t]
    \centering
    \includegraphics[width=0.85\linewidth]{appD/D07-convergence_8_3_S3}
    \caption{
  ...
  \subsubsection*{Spectral Observable and Monte--Carlo Estimator}
    ...
    \begin{figure}[t]
      ...
      {appD/D07-compare_mc_vs_weighted_laplacian_hopf_fiberbase_split_1}
      \caption{
    ...
    \begin{figure}[t]
      \centering
      \includegraphics[width=0.72\linewidth]
      {appD/D07-compare_mc_vs_weighted_laplacian_hopf_fiberbase_split_2}
      \caption{
  ...
  \subsubsection*{Emergence of the \texorpdfstring{$8/3$}{8/3} Ratio}
    ...
    \begin{figure}[t]
      \centering
      \includegraphics[width=0.72\linewidth]
      {appD/D07-compare_mc_vs_weighted_laplacian_hopf_fiberbase_split_3}
      \caption{
