\subsection{Topological Stability of Relational \texorpdfstring{$\chi$}{χ} Configurations}
  ...
  \paragraph{Geometric metaphors and their limits.}
    ...
    For instance, while a \textbf{Möbius strip} can heuristically illustrate the \(4\pi\)-periodicity of an electron's
    spin, the \textbf{trefoil knot} provides a geometric metaphor for the proton's
    topological complexity.
    These metaphors become quantitatively meaningful only when linked to the **fiber
    volumes** under the projection \(\Pi\), which determine the particle's mass and stability.
