...
\abstract{
  ...
  indeterminacy, \textbf{entanglement and nonlocal correlations}, discreteness,
  and horizon phenomena.
  Quantum mechanics thus emerges as an effective statistical framework governing
  the admissible projections of a non-injective underlying reality.
  Within this setting, particle masses arise as invariant spectral properties of stable
  $\chi$-configurations, resulting from topological frustration and inhibition of
  relaxation rather than from fundamental coupling constants or symmetry-breaking
  mechanisms.
  ...
  geometry, quantum phenomena, gravitation, and the observed growth of cosmological
  complexity arise as emergent harmonics of a single irreversible relaxation process,
