\subsection{Bounds on Projective Resolvability Across Scales}
  ...
  These bounds do not only constrain the magnitude and rate of effective responses.
  They also impose a non-trivial consistency condition on the existence of terminal
  states within the projected description, with direct implications for the origin of
  temporal ordering.
