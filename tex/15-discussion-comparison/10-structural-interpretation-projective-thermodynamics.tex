...
% Connections
  ...
  This perspective suggests that limits on effective thermodynamic and geometric
  descriptions ultimately reflect a more general bound on projective accessibility,
  whose implications extend beyond saturation phenomena to the very structure of
  state transitions in the effective description.
