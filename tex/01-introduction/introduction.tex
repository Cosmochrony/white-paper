...
\section{Introduction}
  ...
  These projections are generically non-injective, allowing multiple underlying
  $\chi$-configurations to correspond to identical effective observables
  (see Section~\ref{subsec:projection-reality-and-ontological-asymmetry} for a
  detailed treatment).
  ...
  propagation speed, whose effective projection defines the observed causal
  limit $c$.
