\subsection{Interpretative Status of the \texorpdfstring{$\chi$}{χ} Field}
  \label{subsec:nature-chi}

  This appendix supplements the primary definition of $\chi$ given in
  Section~\ref{subsec:definition-of-the-chi-field}.
  It does not introduce new postulates, but provides interpretative clarifications
  to prevent common misreadings suggested by conventional field-theoretic language.
  ...
  Fundamentally, $\chi$ encodes a \textbf{non-energetic relational scale of relaxation}
  from which notions such as duration, distance, and causal ordering are reconstructed.
  ...
  graining becomes meaningful, \textbf{without implying an underlying differentiable
  ...
  ontological or kinematical commitments.
