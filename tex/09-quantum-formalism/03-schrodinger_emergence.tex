\subsection{Emergence of the Schr\"odinger Equation as an Effective Description}
  ...
  \subsubsection*{Operators and Algebra from \texorpdfstring{$\chi$}{χ} Fluctuations}
    ...
    variations of projected configurations of the pre-geometric substrate $\chi$.
    ...
    As a consequence, multiple underlying relational configurations correspond to the
    same effective spacetime description.
    ...
    \begin{equation}
      ...
      distinct relational aspects of $\chi$ configurations whose projection is not
      jointly injective.
...
theory of projection degeneracy}, providing a compact and predictive language
