\abstract{%
  ...
  Observable states are obtained through a fixed generically non-injective
  projection~$\Pi$, whose non-injectivity is a structural necessity rather
  than an independent assumption: any framework that distinguishes an
  infra-physical level from an observable level must admit such a map.
