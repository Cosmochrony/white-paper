\subsection{Spectral Characterization of Mass and the Secondary Role of \texorpdfstring{$V(\chi)$}{V(χ)}}
  ...
  \emph{The graph representation is not ontological but serves as a computational proxy
  for relational adjacency in the projectable regime.}
  ...
  \paragraph{Residual role of the potential \texorpdfstring{$V(\chi)$}{V(χ)}.}
  ...
  \paragraph{Origin of the effective potential \texorpdfstring{$V(\chi)$}{V(χ)}.}
