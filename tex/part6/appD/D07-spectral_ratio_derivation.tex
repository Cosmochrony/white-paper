...
% Arrows
  ...
  \begin{figure}[t]
    \centering
    \includegraphics[width=0.85\linewidth]{part6/appD/D07-convergence_8_3_S3}
    \caption{
      Monte--Carlo convergence of the spectral ratio $R = 8\langle\cos^2\rangle /
      \langle\sin^2\rangle$ toward the universal value $8/3$ for uniform sampling on $S^3$.
      ...
      The convergence illustrates the robustness of the ratio and its independence from discretization details.
    }
  ...
  \subsubsection*{Discrete Laplacian on a Representative Graph}
    ...
    defined on a $k$-nearest-neighbor graph $G$ constructed from $N$ points uniformly sampled on $S^3$.
  ...
  \subsubsection*{Spectral Observable and Monte--Carlo Estimator}
    ...
    \begin{figure}[t]
      ...
      {part6/appD/D07-compare_mc_vs_weighted_laplacian_hopf_fiberbase_split_1}
      \caption{
    ...
    \begin{figure}[t]
      \centering
      \includegraphics[width=0.72\linewidth]
      {part6/appD/D07-compare_mc_vs_weighted_laplacian_hopf_fiberbase_split_2}
      \caption{
  ...
  \subsubsection*{Emergence of the \texorpdfstring{$8/3$}{8/3} Ratio}
    ...
    \begin{figure}[t]
      \centering
      \includegraphics[width=0.72\linewidth]
      {part6/appD/D07-compare_mc_vs_weighted_laplacian_hopf_fiberbase_split_3}
      \caption{
