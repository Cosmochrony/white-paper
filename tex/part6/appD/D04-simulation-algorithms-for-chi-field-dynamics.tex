...
\end{algorithmic}
  ...
  \begin{figure}[t]
      \centering
      \includegraphics[width=0.95\linewidth]{part6/appD/D04_entanglement_intermittence_b}
    ...
    \textit{The absence of a smooth ‘entanglement bell curve’ is not a numerical artifact but a structural
    prediction
    of
