% ----------------------------------------------------------------------------
% A.5 --- Strong-Field Constitutive Coupling Near Schwarzschild BH
...
Identifying $K_{\mathrm{eff}}/K_0 \equiv N(r)^2$ yields:
\begin{equation}
  K_{\mathrm{eff}}(r)
...
conductivity ($K_{\mathrm{eff}} \to 0$), reinterpreting black holes as
regions where collective structural constraints asymptotically inhibit
relaxation.
