\subsection{Evolution of the Hubble Parameter and the Hubble Tension}
  ...
  \paragraph{Illustrative \texorpdfstring{$H(z)$}{H(z)} profile and comparison with \texorpdfstring{$\Lambda$}{Λ}CDM.}
  ...
  \paragraph{Predicted amplitude of the deviation at \texorpdfstring{$z\sim 1$}{z~1}.}
