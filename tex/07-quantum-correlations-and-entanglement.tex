\subsection{Non-locality and the Holistic Nature of the Field}
  ...
  \end{equation}
  where $x_1$ and $x_2$ are their respective positions. A measurement or interaction at $x_1$ does not ``send a
  signal'' to $x_2$; rather, it interacts with a sub-element of a globally unified structure.
...
\subsection{Measurement and Decoherence}\label{subsec:measurement-and-decoherence}
...
\subsection{Limits of Entanglement}\label{subsec:limits-of-entanglement}
...
\subsection{Summary}\label{subsec:summary5}
