\subsection{Spectral and Inertial Quantities}
  ...
  \paragraph[$\Delta_{\Pi}$] \textit{Projective stability gap of a composite fiber class.}
  ...
  \paragraph[$\Delta_{\Pi}^{\mathrm{ampl}}$] \textit{Amplitude (formation) scale associated with composite stability.}
