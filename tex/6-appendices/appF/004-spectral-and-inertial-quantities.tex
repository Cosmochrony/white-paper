\subsection{Spectral and Inertial Quantities}
  ...
  \paragraph[$\Delta_{\Pi}$]{Projective stability gap of a composite fiber class.}
    $\Delta_{\Pi}$ is defined as the lowest positive eigenvalue of the effective
    projective stability operator restricted to the fiber sector around a composite
    winding configuration (notably $w=2$),
  ...
  \paragraph{\texorpdfstring{$\lambda_n$}{λn} (Spectral eigenvalues).}
    Eigenvalues of the linearized projective stability operator acting on small
