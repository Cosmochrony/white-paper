\subsection{Effective and Projected Quantities}
  ...
  \paragraph[$\rho_s$]{Phase stiffness (superconducting coherence stiffness).}
    $\rho_s$ denotes the effective stiffness associated with spatial variations of the coherent $U(1)$ fiber phase.
    It is an operational proxy for the collective projective capacity of the projected description in the coherent
    regime.
    In Section~\ref{subsec:collective-U1-coherence}, $\rho_s$ controls the energetic cost of phase gradients
    and enters the London-type gradient term through
    $F_{\mathrm{grad}} \propto (\nabla\theta - (2e/\hbar)A)^2$.
    $\rho_s$ is not a fundamental constant of the $\chi$ substrate.
    It is a regime-dependent effective quantity, vanishing when coherence is lost and recovering normal-state behavior.
  ...
  \paragraph{\texorpdfstring{$t_{\mathrm{proj}}$}{tproj} (Projected time).}
    ...
    It arises from the local rate of projective ordering and reproduces relativistic
  ...
  \paragraph{Universe.}
    ...
    The Universe does not refer to the pre-geometric relational substrate $\chi$,
    which is ontologically prior to any notion of universe.
