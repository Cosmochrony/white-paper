\subsection{Effective and Projected Quantities}
  ...
  \paragraph[$\rho_s$] \textit{Phase stiffness (superconducting coherence stiffness).}
    $\rho_s$ denotes the effective stiffness associated with spatial variations of the coherent $U(1)$ fiber phase.
    It is an operational proxy for the collective relaxation capacity of the projected description in the coherent
    regime.
