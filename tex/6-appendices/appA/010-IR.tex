\subsection{Infrared expansion of the coherence functional}
  ...
  This subsection completes the necessity argument introduced in Section~\ref{sec:necessity-noninjective}.
  Having excluded injective admissible projections in
  Section~\ref{subsec:injective-holonomy},
  we now show that under non-injective admissible projection
  satisfying the saturation bound of Section~\ref{sec:dynamical-equation-for-the-chi-field},
  the infrared effective dynamics is uniquely selected.
  In particular, the Einstein--Hilbert term arises as the leading
  infrared contribution of the coherence functional.
  ...
  In the infrared regime $\ell_c \gg \ell_\chi$ (with $\ell_\chi = \hbar_\chi / c_{\mathrm{BI}}$
  ...
  \paragraph{Step 3: integration by parts and the Gauss--Bonnet identity.}
    ...
    \begin{equation}
      ...
      = \frac{c_{\mathrm{BI}}^3}{\hbar_\chi} \cdot \frac{1}{16\pi} \cdot R
      + \mathcal{O}(\ell_c^{-4}),
      \label{eq:defect-IR-expansion}
    \end{equation}
    where the prefactor $c_{\mathrm{BI}}^3 / \hbar_\chi$ matches the dimensions of the
