\subsection{Effective Lagrangian Description as a Hydrodynamic Limit}
  ...
  Distances emerge as cumulative resistance to projective ordering advancement.
  ...
  parametrizes how the projective ordering structure is encoded in the
  ...
  If the projective flux approaches saturation and effective injectivity fails,
