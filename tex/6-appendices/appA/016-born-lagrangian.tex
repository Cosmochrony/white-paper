\subsection{Relational Consistency of the Effective Lagrangian}
  ...
  \subsubsection*{Step 5: Connection to Emergent Geometry}
    ...
    (Appendix~\ref{subsec:chi_eff-validation}).
  ...
  \subsubsection*{Necessity of the Born--Infeld Structure}
    ...
    propagation, contradicting the maximal admissible projective flux~$c_{\mathrm{BI}}$.
    The Born--Infeld form is the minimal non-polynomial functional
    enforcing strict saturation, causal consistency, and
    self-regularization.
    The saturation constant $b$ represents the substrate's upper admissible
    projective flux bound; the speed of light $c$ is a derived parameter
    with $c \le b$.
