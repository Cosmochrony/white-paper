\subsection{First nonlinear correction from finite projective capacity}
  ...
  \subsubsection*{Projective occupancy}
    ...
    weights (normalised to unity), and $A_n^{\max} = c_{\mathrm{BI}}/\sqrt{\lambda_n}$ is the
  ...
  \subsubsection*{Density-dependent correction to the local phase evolution}
    ...
    $\psi(x,t)$ with a phase weight determined by its admissible projective rate.
  ...
  \subsubsection*{Effective nonlinear equation}
    ...
    \begin{remark}[Structural interpretation of the cubic term]
      ...
      It encodes the \emph{self-retroaction of projective multiplicity}: the density
  ...
  \subsubsection*{Regime diagram}
    ...
    \begin{itemize}
      ...
      regimes; the effective description approaches the boundary of projectability.
    \end{itemize}
  ...
  \subsubsection*{Structural status}
    ...
    of the bounded-flux condition $|\partial_t\chi_v| \leq c_{\mathrm{BI}}$.
