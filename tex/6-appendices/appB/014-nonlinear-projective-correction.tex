\subsection{First nonlinear correction from finite projective capacity}
  ...
  \subsubsection*{Structural status}
    ...
    This closes the logical chain from the admissibility bound (Section~2.4)
    through the linear Schr\"{o}dinger emergence (§B.12) to the present nonlinear
    correction.
    ...
    and collective quantum dynamics~\cite{Superconductivity1}.
