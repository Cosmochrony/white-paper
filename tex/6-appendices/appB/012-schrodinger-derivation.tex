\subsection{Emergence of the Schr\"{o}dinger equation as an effective projected dynamics}
  ...
  \subsubsection*{Main theorem}
    ...
    \paragraph{Step 1: Substrate dynamics and linearization.}

      At the substrate level, the primitive dynamics is governed by the admissibility
      structure of $\Pi$ and takes the generic form
      \[
