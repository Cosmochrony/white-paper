\subsection{Bounded Flux as the Origin of Character Vanishing}
  ...
  \end{equation}
  where $c_\chi$ is the maximal relaxation speed.
  ...
  The local relaxation cost associated with $s$ is proportional to the real part of
  ...
  sector as defined by the dynamics of the $\chi$ substrate.
