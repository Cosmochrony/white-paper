...
Behavior}
  ...
  $\mathrm{SU}(2) \to \mathrm{SO}(3)$ and is topologically compatible
  with fermion-like transformation behavior without introducing
  fundamental spinor fields.
  The sign change is an effective encoding of the $\mathbb{Z}_2$ obstruction (Section~\ref{subsec:status-formulation}:
