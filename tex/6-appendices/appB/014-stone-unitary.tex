\subsection{Unitary evolution group and Stone's theorem}
  ...
  one-parameter unitary group, and identifies the precise role of the BAT hypotheses
  ...
  \paragraph{Setting.}
    ...
    \begin{remark}
      Proposition~\ref{prop:omega-selfadjoint} is not independent of the BAT hypotheses.
    ...
    \begin{theorem}[Unitary evolution group]
      ...
      \begin{enumerate}
        ...
        \[
          ...
          \qquad \hat{H}_{\mathrm{eff}} = \hbar_{\mathrm{eff}}\,\Omega.
        \]
