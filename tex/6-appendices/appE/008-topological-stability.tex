\subsection{Topological Stability of Relational \texorpdfstring{$\chi$}{χ} Configurations}
  ...
  Stability arises from topological obstructions to the advancement of
  the projective ordering: certain configurations cannot be continuously
  deformed to the homogeneous admissible vacuum without passing through
  forbidden regions.
