...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.78\linewidth]
    {6-appendices/appD/D04_saturation_fraction_compare}
...
\begin{figure}[t]
  ...
  \includegraphics[width=0.72\linewidth]
    {6-appendices/appD/D04_residual_hist_smooth}
...
\begin{figure}[t]
  ...
  \includegraphics[width=0.47\linewidth]
    {6-appendices/appD/D04_chi_eff_slice_smooth}
  \hfill
  \includegraphics[width=0.47\linewidth]
    {6-appendices/appD/D04_residual_slice_smooth}
