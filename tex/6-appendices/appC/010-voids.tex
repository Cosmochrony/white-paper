\subsection{Cosmic Voids as Observational Tests of Maximal Projective Capacity}
  \label{subsec:observational-tests-voids}

  Voids probe the regime of near-maximal projective saturation, where
  departures from $\Lambda$CDM are most pronounced.
