\section{Conclusion and Outlook}
  ...
  \begin{itemize}
    ...
    Fermionic properties emerge from topological obstructions in the configuration space of $\chi$, while inertial
    mass is not postulated but arises from resistance to global relaxation, quantified by the \textit{spectral overlap}
    between localized excitations and the relaxation background.
