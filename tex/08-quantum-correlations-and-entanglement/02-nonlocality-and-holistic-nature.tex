\subsection{Nonlocality and the Holistic Character of Projected Descriptions}
  ...
  This non-factorizable character originates from the non-injective nature of the
  projection from the underlying $\chi$ substrate to effective descriptions:
  ...
  This follows from the fact that no unique injective mapping exists between local
  projected properties and the underlying $\chi$ configuration.
