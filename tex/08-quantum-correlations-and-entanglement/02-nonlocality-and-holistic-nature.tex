\subsection{Nonlocality and the Holistic Character of Projected Descriptions}
  ...
  From the standpoint of \textbf{Ontological Monism}, entangled systems are not composed of
  ontologically independent parts: they are multiple effective images of a single $\chi$-configuration,
  constrained by shared projectability conditions.
  ...
  This non-factorizable character reflects the fact that admissible projected
  descriptions are globally constrained and cannot, in general, be decomposed
  into independent effective subsystems.

  Entangled systems correspond, at the level of effective descriptions, to single
  single projected configurations originating from a common underlying $\chi$
  configuration that cannot be decomposed into independent subsystems
  ...
  This follows from the absence of any injective correspondence between local
  projected properties and globally admissible descriptions.
