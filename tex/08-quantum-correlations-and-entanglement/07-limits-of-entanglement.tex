\subsection{Limits of Entanglement and Environmental Effects}
  ...
  a non-factorizable projected description remains jointly admissible within an
  effective spacetime representation.
  Once such global descriptions cease to be admissible or projectable, entanglement
  necessarily breaks down at the effective level.
  ...
  From this perspective, environmental coupling restricts the space of admissible
  projected descriptions to locally stable, approximately factorizable regimes,
  thereby suppressing access to non-factorizable correlations.
  ...
  Classical behavior thus corresponds to regimes in which only effectively
  factorizable projected descriptions remain admissible, rendering non-factorizable
  correlations operationally inaccessible.
