\subsection{Measurement, Decoherence, and Apparent Collapse}
  ...
  This behavior reflects the fact that effective projected descriptions do not admit
  a unique inverse mapping to underlying relational configurations.
  ...
  From this perspective, decoherence corresponds to an effective restriction of the space of admissible
  projected descriptions to locally stable, approximately factorizable regimes to a set of locally injective
  descriptions.
  ...
  \begin{tcolorbox}[
    ...
    In the Cosmochrony framework, this behavior follows from the global consistency constraints governing admissible
    projected descriptions.
    A single underlying $\chi$ configuration may admit multiple effective descriptions, none of which defines a unique
    local past prior to measurement.
