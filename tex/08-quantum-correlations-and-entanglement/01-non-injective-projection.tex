\subsection{Non-Factorizable Projected Descriptions and Quantum Correlations}
  ...
  Quantum correlations and entanglement in Cosmochrony arise when effective
  descriptions cannot be factorized into independent subsystems.
  Building on the non-injectivity of the projection $\Pi$ established in
  Section~\ref{sec:relational_projection}, we show that distinct effective degrees
  of freedom may correspond to multiple projective manifestations of a single
  ...
  As a consequence, effective degrees of freedom cannot be assigned independent states.
