\subsection{Variational Formulation and Born--Infeld Action}
  ...
  The effective Lagrangian (\eqref{eq:leff_equation}) should be understood as an auxiliary variational representation.
  Its physical interpretation is discussed in Appendix~\ref{subsec:hydrodynamic-limit},
  while its mathematical consistency with the relational discrete dynamics is established in
