\subsection{Structural Origin of Quantum Correlations and Non-Locality}
  ...
  \subsubsection*{Torsional Conservation and the Origin of Spin Correlations.}
    ...
    \begin{itemize}
      ...
      \itemThis mechanism ensures the conservation of global topological invariants across the shared projection without
      violating the causal bounds of the relaxation dynamics.
    \end{itemize}
