\subsection{Perspectives: Towards a Derivation of the Proton-to-Electron Mass Ratio}
  ...
  \subsubsection*{Role of \(V(\chi)\) and Fine Structure}
    ...
    Although introduced here in the context of particle mass hierarchies,
    the spectral packing fraction $\alpha$ is expected to be a universal
    property of non-injective projection.
    In later sections, we argue that the same quantity governs the spectral
    granularity of horizon-associated reprojection phenomena.
