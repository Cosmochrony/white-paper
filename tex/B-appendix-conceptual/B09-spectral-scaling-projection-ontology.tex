\subsection{Spectral Scaling and the Projection Ontology}
  ...
  \paragraph{Mass as Spectral Weight}
    ...
    magnitude and microscopic degeneracy, but asserts that both track the same coarse-grained constraint—projectability
  ...
  \paragraph{Invariance of the Ratio}
    ...
    to the extent that it is observationally constrained to be stable, regardless of the global relaxation state of $\chi$.
  ...
  \paragraph{The Spectral Packing Fraction (\texorpdfstring{$\alpha$}{α})}
    ...
    configuration, leads to a strong spectral gap between the binding modes $\lambda_{\mathrm{bind}}$ and the fundamental
