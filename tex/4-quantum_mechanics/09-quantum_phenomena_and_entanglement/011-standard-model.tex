...
the Hodge Laplacian~$\Delta_1$ acting on 1-forms of the fiber bundle~$\Pi$.
The space of 1-forms decomposes into gauge-invariant subspaces $\Omega^1_{SU(2)}$ and $\Omega^1_{U(1)}$.
...
between internal stability spectra and the global projective admissibility structure:
\begin{equation}
