\subsection{Cosmological Imprints: The $8/3$ Scaling in CMB Polarization}
  ...
  \subsubsection*{Geometric Bound on the Tensor-to-Scalar Ratio ($r$)}
  ...
  \subsubsection*{Topological Decoherence and Parametrization of $r_{\text{obs}}$}
