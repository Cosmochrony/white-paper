\subsection{The Big Bang as a Maximal Constraint Regime of the \texorpdfstring{$\chi$}{χ} Substrate}
  ...
  \textbf{In this regime, effective geometric and thermodynamic parameters fail not
  because of unbounded dynamics, but because the projection from the relational
  substrate becomes maximally non-injective under saturating constraint conditions.}
