...
\part{Predictions, Discussion, and Conclusion}
  ...
  Where available, these predictions are grounded in spectral results established in the
  O-series admissibility programme~\cite{Beau2026a1,Beau2026a31}, providing an independent
  numerical foundation for the phenomenological claims.
  ...
  \clearpage
  \input{5-predictions_discussion_conclusion/10-radiation-and-quantization/chapter}
  \input{5-predictions_discussion_conclusion/11-spectral-mass-hierarchy/spectral-mass-hierarchy}
  \input{5-predictions_discussion_conclusion/12-testable-predictions-and-observational-signatures/chapter}
  \input{5-predictions_discussion_conclusion/13-discussion-comparison-existing-frameworks/discussion-comparison-existing-frameworks}
  \input{5-predictions_discussion_conclusion/14-conclusion/conclusion}
