...
\part{Predictions, Discussion, and Conclusion}
  ...
  \clearpage
  \input{5-predictions_discussion_conclusion/09-radiation-and-quantization/chapter}
  \input{5-predictions_discussion_conclusion/10-spectral-mass-hierarchy/spectral-mass-hierarchy}
  \input{5-predictions_discussion_conclusion/11-testable-predictions-and-observational-signatures/chapter}
  \input{5-predictions_discussion_conclusion/12-discussion-comparison-existing-frameworks/discussion-comparison-existing-frameworks}
  \input{5-predictions_discussion_conclusion/13-conclusion/conclusion}
