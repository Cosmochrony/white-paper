\subsection{Conceptual Implications and Open Challenges}
  ...
  advancement; irreversibility reflects the one-way activation of projected
  modes --- a property of spectral modes in the Gram--Schmidt span, compatible
  with the structural reorganization of coherent configurations into more stable
  ones (Section~\ref{subsec:metastability-and-decay}).
  ...
  features, the identification of a structural carrier for the inter-generation mass
  hierarchy compatible with the no-go results of the fermionic-matter
  sub-programme~\cite{Beau2026pyo,Beau2026fmnote}, the quantitative
