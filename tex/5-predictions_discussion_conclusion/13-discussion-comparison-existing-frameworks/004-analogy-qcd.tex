\subsection{Analogy with Collective Phenomena in QCD}
  ...
  of~$\chi$ and its projective structure.
  ...
  Gravitational curvature arises as a collective constraint on the local
  projective ordering rate.
  Schwinger pair production corresponds to saturation of the directed
  admissible projective flux.
  Superconductivity, as discussed in Section~\ref{subsec:collective-U1-coherence},
  ...
  In all these cases, the effective phenomena are not introduced as additional dynamical postulates.
  They correspond to regime-dependent reorganizations of the same projective structure.
