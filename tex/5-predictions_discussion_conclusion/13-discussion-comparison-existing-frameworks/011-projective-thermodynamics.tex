\subsection{Structural Responses to Bounded Projective Capacity}
  ...
  The $\chi$ substrate is governed by a bounded admissible projective flux,
  characterized by a Born--Infeld-type constraint $b_{\mathrm{BI}}$.
  This bound limits the admissible transfer of projective capacity
  and prevents divergence of effective observables.

  When the projective flux approaches its admissible bound,
  ...
  The relationship between the fluctuation amplitude and the admissible projective flux
  defines a hierarchy of five regimes, ranging from the irreducible projective floor
  to the inadmissible regime beyond the Born--Infeld ceiling.
  ...
  \paragraph{Level 2 --- Normal fluctuation regime.}
    ...
    residual norms grow under unstable directions of the admissible dynamics~$F$.
  ...
  \paragraph{Level 3A --- Thermodynamic compensation.}
    ...
    The unresolved projective flux is therefore absorbed into
    ...
    interpretable as a compensatory response to bounded projective capacity
  ...
  \paragraph{Level 4 --- Beyond the Born--Infeld ceiling.}
    ...
    When the projective flux exceeds the admissible bound~$b_{\mathrm{BI}}$,
    ...
    Pair creation thus acts as a dissipative channel that redistributes excess projective
    ...
    universal transition between smooth admissible projection and topologically mediated
    dissipation.

  \paragraph{Unified interpretation.}

    These five levels do not represent distinct physical mechanisms but a single
    continuous structural response to the bounded projective capacity constraint,
    resolved differently depending on the amplitude of the flux, the coherence of
    the fiber, and the dynamical accessibility of collective reorganization.
    ...
    The bounded character of the admissible projective flux ensures that
    ...
    \begin{figure}[t]
      ...
      \begin{tikzpicture}[
        ...
        {\footnotesize bounded admissible flux}};
        ...
        \draw[thick] (pi) -- (obs);
      \end{tikzpicture}
      \caption{Structural responses to bounded projective capacity.
