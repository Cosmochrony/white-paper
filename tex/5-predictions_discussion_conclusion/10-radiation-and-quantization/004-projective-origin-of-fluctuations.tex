\subsection{Projective Origin of Fluctuations}
  ...
  \begin{remark}[Algebraic necessity of projective fluctuations]
    \label{rem:fluctuations-algebraic}
    The account above derives the existence of fluctuations from the non-injectivity
    of~$\Pi$ and the fibre drift under the ordering parameter.
    This non-injectivity is itself anchored in a deeper algebraic fact: the
    non-commutativity $[X,\sigma(X)] = Z \neq 0$ of the admissible fibre generators
    structurally forbids any projection with trivial kernel~\cite{Beau2026m}.
    Fluctuations are therefore not a contingent consequence of how~$\Pi$ happens
    to be constructed: they are a necessary consequence of the Heisenberg structure
    of the admissible fibre.
    No admissible projection — and hence no effective description within this framework
    — can eliminate fluctuations entirely.
    The quantum vacuum is not a state from which fluctuations could in principle be
    removed; it is the state from which their removal is structurally forbidden.
  \end{remark}
