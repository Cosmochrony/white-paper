\subsection{Projective Origin of Fluctuations}
  ...
  once projected, are precisely what the effective description identifies as differences in operational time~$\tau$.
  ...
  the co-projecting set determined by the current value of the relaxation-ordering parameter~$\lambda$.
  Between two successive steps $U_n$ and $U_{n+1}$, $\lambda$ has advanced, and the set
  of substrate configurations that co-project onto the same observable~$o$ is therefore not identical.
  ...
  fixed~$\lambda$: time, understood as the projected image of relaxation ordering, is the
  minimal and irreducible source of the observed noise.
...
Lie-derivative along the relaxation vector field---is left as an open structural direction.
  ...
  Two distinct mechanisms may contribute to the apparent randomisation of successive projection residuals.
  ...
  so that successive residuals become uncorrelated without necessarily growing in amplitude.
  ...
  admissibility constraint~$A^{\mathrm{BI}}_{\max}$, at which point the projection enters
  a saturation regime and structural compensation mechanisms become
  operative~\ref{subsec:structural-interpretation-projective-thermodynamics}.
  Whether this second mechanism is active, and how it relates to the decorrelation
  regime, remains an open structural question.
  The Born--Infeld bound thus plays a dual role: it caps the amplitude of projective
  amplification, and replaces the ultraviolet divergences of standard quantum field theory
  with a finite structural ceiling, rendering renormalisation unnecessary as an independent
  procedure.
