\subsection{Radiation as a Projective Reconfiguration}
  \label{subsec:radiation-as-chimatter-interaction}

  Radiation arises when a locally stable projected configuration undergoes
  a transition toward a less constrained state.
