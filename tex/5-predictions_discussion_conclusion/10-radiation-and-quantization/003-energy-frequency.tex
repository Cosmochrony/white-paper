...
\texorpdfstring{$E = h\nu$}{E = hν}}
  ...
  Building on Section~\ref{subsec:energy-frequency-solitons}, the Planck relation
  \begin{equation}
    E = h \nu
  \end{equation}
  acquires a geometric interpretation in the context of radiative processes.
  The energy~$E$ measures the projective capacity redistributed during a
  ...
  substrate invariant
  $\hbar_\chi \equiv c^3 / (K_{0,\text{bare}}\,\chi_{c,\text{bare}})$
  (Section~\ref{subsec:renormalization-hbar}), acting as a universal
  conversion factor between structural projective capacity and temporal
  ...
  a minimal unit of effective projective capacity transfer determined by the
