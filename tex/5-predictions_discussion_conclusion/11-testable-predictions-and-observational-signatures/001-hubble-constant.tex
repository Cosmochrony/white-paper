...
\texorpdfstring{$\chi$}{χ} Dynamics}
  ...
  \paragraph{Resolution of the Hubble tension.}
    ...
    \begin{figure}[t]
      ...
      redshifts due to relaxation inhomogeneities. The Cosmochrony band corresponds to the admissible interval in
        ($\Omega_{\chi}$, $\delta$) entering the bounded-response mechanism,
        with $a_{\star}$ fixed independently; it represents structural uncertainty rather than parameter fitting.}
