...
\section{Conclusion and Outlook}
  ...
  \subsection*{Conceptual Shift and Outlook}
    ...
    to a ``relaxation-of-substrate'' ontology, in which spacetime,
    quantum behaviour, and interactions emerge from a single underlying process.

    Immediate falsifiable research directions include:
    cosmological signatures (low-$\ell$ CMB anomalies induced by finite relaxation capacity),
    galactic phenomenology (systematic correlation between apparent dark matter effects
    and local relaxation gradients), and fundamental-scale effects
    (environment-dependent variations in decay rates or effective couplings in regimes
    approaching admissibility saturation).
    ...
    and topological classes within the relational relaxation dynamics,
    including the quantitative emergence of chirality selection and
