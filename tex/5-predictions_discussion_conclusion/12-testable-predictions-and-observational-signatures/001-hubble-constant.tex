\subsection{Hubble Constant from Projective Structure}
  ...
  $H_0 \simeq c/\chi(t_0)$.
  Early- and late-universe probes sample~$\chi$ at different projective ordering stages,
  naturally leading to systematically different inferred values
  ...
  \paragraph{Resolution of the Hubble tension.}
    ...
    \begin{figure}[t]
      ...
      redshifts due to projective capacity inhomogeneities.
      The Cosmochrony band corresponds to the admissible interval in
        ($\Omega_{\chi}$, $\delta$) entering the bounded-response mechanism,
        with $a_{\star}$ fixed independently; it represents structural uncertainty
