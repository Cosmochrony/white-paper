\subsection{Conceptual Context and Related Approaches}
  ...
  recovered from spectral information, the spectral operator itself is typically postulated as fundamental.
  In contrast, Cosmochrony addresses the origin of
  spectral structure, deriving it from the relational Laplacian of the
  $\chi$-substrate under bounded relaxation and finite projectability.
