...
\section{Introduction and Motivation}
  ...
  Any attempt to account for the emergence of spacetime therefore faces a
  conceptual constraint: the origin of spacetime cannot be formulated within
  spacetime itself.
  Descriptions that presuppose temporal evolution, spatial propagation, or
  geometric locality are necessarily inadequate to explain how such notions
  first arise.
  This suggests that a successful foundational framework must be formulated in
  terms that do not rely on pre-existing temporal or geometric structures.

  From this perspective, the problem of unification is not merely one of combining
  dynamical laws, but of identifying a level of description from which spacetime,
  causality, and dynamical evolution can appear as effective concepts.
  Such a level must be relational rather than geometric, and structural rather
  than kinematic.
  Its role is not to describe physical processes occurring \emph{in} spacetime,
  but to account for the conditions under which spacetime descriptions become
  meaningful at all.
  ...
  constraints, without assuming spacetime as a fundamental ingredient.
  ...
  require a common origin beyond spacetime-based descriptions.

  \input{1-foundations/01-introduction-and-motivation/sec-unification}
  \input{1-foundations/01-introduction-and-motivation/sec-minimalism}
  \input{1-foundations/01-introduction-and-motivation/sec-time}
  \input{1-foundations/01-introduction-and-motivation/sec-context}
  \input{1-foundations/01-introduction-and-motivation/sec-scope}
  \input{1-foundations/01-introduction-and-motivation/sec-plan}

  For convenience, a glossary summarizing the main quantities and operators used
  throughout the article is provided in Appendix~\ref{sec:glossary}.
