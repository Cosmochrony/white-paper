...
\section{Introduction and Motivation}
  ...
  constraints operative at an infra-physical level, without assuming spacetime
  itself to be explanatorily complete.
  ...
  their empirically validated domains.
  It offers a coherent infra-physical framework designed to expose the common
  structural foundations from which time, geometry, gravitation, and quantum
  correlations emerge, and to show that several phenomena currently treated as
  independent postulates admit a common projective origin.
  ...
  \input{1-foundations/01-introduction-and-motivation/004-sec-context}
  \input{1-foundations/01-introduction-and-motivation/005-sec-scope}
  \input{1-foundations/01-introduction-and-motivation/006-sec-plan}
