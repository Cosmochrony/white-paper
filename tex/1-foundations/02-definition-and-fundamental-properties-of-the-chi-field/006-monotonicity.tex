...
\cdots \cup S_n\}$ is non-decreasing, $\dim V_n \le q$, and the rank
    ...
    \begin{enumerate}[label=(\roman*)]
      ...
      of admissible projective flux, and
      \item the non-injectivity of~$\Pi$, which controls how spectral
      structure accumulates across fibres.
    \end{enumerate}
    Quantitative control of shell-wise spectral saturation in the Weil sector
    of~$\mathrm{Heis}_3(\mathbb{Z}/q\mathbb{Z})$ is the analytical task
    required to close the conjecture.
